...
HTTP BFF for the quant portal: JWT login, CORS for the React app, and gRPC fan-out to core-service, the core-service-owned order.v1 API, strategy-service, and control-panel-service. Responses use JSON only and do not include exchange API secrets.
